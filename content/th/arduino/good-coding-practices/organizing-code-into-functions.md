...
## มันคืออะไรและทำไม?
การจัดระเบียบโค้ดเข้าสู่ฟังก์ชันหมายถึงการแบ่งโค้ดของคุณออกเป็นส่วน ๆ ที่สามารถใช้ซ้ำได้ โดยแต่ละส่วนทำงานเฉพาะกิจ โปรแกรมเมอร์ทำเช่นนี้เพื่อให้โค้ดอ่านง่ายขึ้น ติดตามข้อผิดพลาดและนำกลับมาใช้ใหม่ได้ง่ายขึ้น มันเหมือนกับการจัดเรียงเลโก้เข้าสู่กล่อง - ช่วยคุณจากการต้องค้นหาในกองที่ยุ่งเหยิงทุกครั้งที่คุณต้องการสร้างบางอย่าง
