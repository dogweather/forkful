...
## อะไร & ทำไม?
การ log หรือการบันทึกล็อกคือกระบวนการบันทึกเหตุการณ์ที่เกิดขึ้นภายในแอปพลิเคชันซอฟต์แวร์ โปรแกรมเมอร์จะบันทึกเหตุการณ์เหล่านี้เพื่อจับข้อมูลในระหว่างทำงาน, แก้ไขปัญหา, ติดตามพฤติกรรมของระบบ และสร้างบันทึกตรวจสอบสำหรับเหตุผลด้านความปลอดภัยและการปฏิบัติตามข้อกำหนด
