...
## อะไรและทำไม?
การส่งคำขอ HTTP พร้อมการรับรองความถูกต้องแบบพื้นฐานเกี่ยวข้องกับการเพิ่มหัวข้อ (header) พร้อมชื่อผู้ใช้และรหัสผ่านเพื่อเข้าถึงทรัพยากรที่ถูกป้องกัน โปรแกรมเมอร์ใช้มันเพื่อการอนุญาตในรูปแบบพื้นฐานในเว็บเซอร์วิส เมื่อวิธีการที่ซับซ้อนกว่าไม่จำเป็น
