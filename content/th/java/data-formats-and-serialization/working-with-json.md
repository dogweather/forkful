...
## คืออะไร & ทำไม?
การทำงานกับ JSON (JavaScript Object Notation) หมายถึงการจัดการกับรูปแบบการแลกเปลี่ยนข้อมูลที่มีน้ำหนักเบานี้ภายในแอปพลิเคชัน Java ของคุณ โปรแกรมเมอร์เลือกใช้ JSON เพื่อการซีเรียลไลซ์ และส่งข้อมูลที่มีโครงสร้างผ่านเครือข่ายและสามารถกำหนดค่าและจัดเก็บข้อมูลได้ง่าย เนื่องจากมันอ่านง่ายสำหรับมนุษย์และไม่ขึ้นกับภาษา
