...
TOML (Tom's Obvious, Minimal Language) เป็นรูปแบบไฟล์การกำหนดค่าที่อ่านง่ายเนื่องจากมีการใช้ภาษาที่ชัดเจน โปรแกรมเมอร์ใช้มันสำหรับไฟล์การกำหนดค่าในแอปพลิเคชันเพราะความเรียบง่ายและความสามารถในการอ่านได้โดยคนทำให้มันเป็นตัวเลือกที่ดีเยี่ยมมากกว่ารูปแบบอื่น ๆ เช่น XML หรือ JSON ในบางบริบท
