...
การแทรกสตริง (String interpolation) ในการเขียนโปรแกรม เกี่ยวข้องกับการสร้างสตริงโดยการฝังนิพจน์ (expressions) ลงในสตริงตามตัวอักษร (literal strings) โปรแกรมเมอร์ทำเช่นนี้เพื่อสร้างข้อความที่มีข้อมูล, คำถามที่มีการเปลี่ยนแปลงได้ หรือเพื่อก่อสร้างสตริงใด ๆ ที่มีเนื้อหาแปรผันได้อย่างมีประสิทธิภาพและสะอาด โดยมักใช้สำหรับผลลัพธ์ของผู้ใช้หรือเพื่อการล็อกข้อมูล
