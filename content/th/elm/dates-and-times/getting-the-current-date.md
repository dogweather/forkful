...
## อะไร & ทำไม?
การเข้าถึงวันที่ปัจจุบันในวิธีการเขียนโปรแกรม Elm หมายถึงการดึงข้อมูลวันที่ปฏิทินปัจจุบันจากระบบ หลักการนี้ถูกใช้เพื่อทำการประทับเวลาเหตุการณ์, กำหนดการทำงาน, หรือติดตามระยะเวลาต่างๆ
