...
ใน Elm, การส่งคำขอ HTTP เป็นวิธีที่แอปพลิเคชันของคุณสื่อสารกับบริการเว็บอื่นๆ เพื่อแลกเปลี่ยนข้อมูล โปรแกรมเมอร์ทำเช่นนี้เพื่อดึงหรือส่งข้อมูลไปยังเซิร์ฟเวอร์, เติมเต็มแอปพลิเคชันด้วยไดนามิกเช่นบัญชีผู้ใช้, คะแนน, หรืออัปเดตข่าวสาร
