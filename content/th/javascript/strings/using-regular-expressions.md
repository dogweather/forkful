...
Regular expressions (regex) ใน JavaScript เป็นรูปแบบที่ใช้สำหรับจับคู่กลุ่มอักขระในสตริง โปรแกรมเมอร์ใช้พวกเขาสำหรับการค้นหา, สกัด, และจัดการข้อความ, ซึ่งทำให้สามารถดำเนินการประมวลผลสตริงที่มีพลังด้วยโค้ดที่กระชับ
