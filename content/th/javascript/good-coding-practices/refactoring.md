...
## อะไร & ทำไม?
การ Refactor คือ กระบวนการปรับโครงสร้างของโค้ดคอมพิวเตอร์ที่มีอยู่โดยไม่เปลี่ยนแปลงพฤติกรรมภายนอก โปรแกรมเมอร์ทำเช่นนี้เพื่อปรับปรุงคุณภาพที่ไม่เกี่ยวข้องกับการทำงานของซอฟต์แวร์ ทำให้โค้ดสะอาดและมีประสิทธิภาพมากขึ้น ซึ่งทำให้การบำรุงรักษาง่ายขึ้นและทำให้การเพิ่มฟีเจอร์ในอนาคตง่ายขึ้น
