...
## อะไร & ทำไม?
การทำงานกับ XML หมายถึง การแยกส่วน, การจัดการ, และการผลิตเนื้อหา XML โดยใช้โค้ด โปรแกรมเมอร์ทำเช่นนี้เพราะ XML ถูกใช้กันอย่างแพร่หลายสำหรับไฟล์การตั้งค่า, การแลกเปลี่ยนข้อมูล และเว็บเซอร์วิส เนื่องจากมีลักษณะที่อ่านได้โดยมนุษย์และสามารถวิเคราะห์โดยเครื่องได้
