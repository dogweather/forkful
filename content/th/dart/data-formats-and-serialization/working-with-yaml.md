...
YAML ย่อมาจาก YAML Ain't Markup Language ซึ่งเป็นรูปแบบการซีเรียลไลซ์ข้อมูลที่อ่านได้โดยมนุษย์ โปรแกรมเมอร์ใช้สำหรับไฟล์การกำหนดค่า, การแลกเปลี่ยนข้อมูล, และในแอปพลิเคชันที่ข้อมูลต้องการจัดเก็บหรือส่งในรูปแบบที่เข้าใจง่าย
