...
การส่งคำขอ HTTP คือวิธีที่โปรแกรมของคุณขอข้อมูลจากเซิร์ฟเวอร์หรือส่งข้อมูลไปยังเซิร์ฟเวอร์ โปรแกรมเมอร์ทำเพราะเป็นหัวใจหลักของการโต้ตอบกับเว็บเซอร์วิส API และทรัพยากรระยะไกล
