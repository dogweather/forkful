...
## อะไร & ทำไม?
การเริ่มโปรเจกต์ใหม่ด้วย TypeScript เป็นเรื่องของการตั้งค่าพื้นฐานที่แข็งแกร่งเพื่อเขียนโค้ดบนนั้น โปรแกรมเมอร์เริ่มต้นโปรเจกต์ใหม่เพื่อเปลี่ยนไอเดียใหม่ๆ เป็นซอฟต์แวร์ที่ทำงานได้จริง, ทดลองแนวคิด, หรือเรียนรู้สิ่งใหม่ๆ
