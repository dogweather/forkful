...
## อะไร & ทำไม?
เดบักเกอร์คือเครื่องมือที่ช่วยให้คุณตรวจสอบและเปลี่ยนแปลงการทำงานภายในของโค้ดขณะที่มันกำลังรันอยู่ โปรแกรมเมอร์ใช้มันเพื่อกำจัดบักโดยการเดินทางผ่านโค้ดของตัวเอง ตรวจสอบตัวแปร และเข้าใจการไหลของโปรแกรมของตน
