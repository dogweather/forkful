...
## อะไรและทำไม?
การใช้งานตัวดีบักใน Elixir มีการเดินผ่านโค้ด, ตรวจสอบตัวแปร, และติดตามการทำงานเพื่อแก้ไขบั๊ก โปรแกรมเมอร์ทำเช่นนี้เพื่อทำความเข้าใจกับสิ่งที่ไม่คาดคิดและให้แน่ใจว่าแอปพลิเคชันทำงานตามที่ออกแบบไว้
