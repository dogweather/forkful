...
ใน Elixir, อาร์เรย์แบบผูกคู่ซึ่งเรียกว่า Maps, เป็นคอลเลคชันของคู่คีย์-ค่าที่คีย์ที่ไม่ซ้ำแต่ละตัวชี้ไปที่ค่าหนึ่ง ๆ พวกมันมีประโยชน์มากสำหรับการเก็บและเรียกข้อมูลได้อย่างรวดเร็ว, ทำให้โค้ดของคุณสะอาดและชีวิตของคุณง่ายขึ้น
