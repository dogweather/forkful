...
## อะไร & ทำไม?
การอ่านอาร์กิวเมนต์บนคอมมานด์ไลน์ช่วยให้โปรแกรมสามารถดึงข้อมูลได้โดยตรงจากเทอร์มินัล—เช่น การตั้งค่าหรือชื่อไฟล์ โปรแกรมเมอร์ทำแบบนี้เพื่อปรับแต่งพฤติกรรมของโปรแกรมโดยไม่ต้องเปลี่ยนโค๊ด
