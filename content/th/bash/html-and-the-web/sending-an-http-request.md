...
การส่งคำขอ HTTP เป็นวิธีหนึ่งในการสื่อสารกับเว็บเซิร์ฟเวอร์เพื่อเรียกข้อมูลหรือส่งแบบฟอร์ม โปรแกรมเมอร์ทำเช่นนี้เพื่อโต้ตอบกับเว็บเซอร์วิส  API หรือเพื่อทำงานอัตโนมัติที่เกี่ยวข้องกับเนื้อหาเว็บ
