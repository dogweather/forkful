...
## อะไรและทำไม?
การแปลงวันที่เป็นสตริงหมายถึงการเปลี่ยนมันเป็นข้อความที่แสดงถึงวันที่ นี่ เราทำเพื่อจัดรูปแบบวันที่ให้มนุษย์อ่านได้หรือเตรียมพวกเขาสำหรับการจัดเก็บในรูปแบบข้อความเช่น CSV หรือ JSON
