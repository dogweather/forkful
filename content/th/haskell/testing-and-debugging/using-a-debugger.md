...
## อะไร & ทำไม?
การใช้งานตัวดีบัก (debugger) หมายถึงการดำดิ่งเข้าไปในโค้ดของคุณด้วยเครื่องมือที่ออกแบบมาเพื่อตรวจสอบ, หยุดชั่วคราว, และแก้ไขโปรแกรมขณะที่กำลังทำงานอยู่ นักเขียนโปรแกรมทำเช่นนี้เพื่อไล่ตามบั๊ก, เข้าใจการไหลของโปรแกรม, และแน่ใจว่าโค้ดของพวกเขาทำงานตามที่คาดหวังไว้จริงๆ
