...
การเปรียบเทียบวันที่สองวันนี้หมายถึงการตัดสินว่าวันไหนเกิดขึ้นก่อน, หลัง, หรือหากเป็นช่วงเวลาเดียวกันหรือไม่ โปรแกรมเมอร์ทำการนี้เพื่อเรียงลำดับเหตุการณ์, คำนวณระยะเวลา, และจัดการกับโลจิกที่ขึ้นอยู่กับเวลา
