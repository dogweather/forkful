...
## สิ่งที่คุณจะได้เรียนรู้และเหตุผลที่ควรทำ
การส่งคำขอ HTTP พร้อมการรับรองความถูกต้องแบบพื้นฐานหมายถึงโปรแกรมของคุณเคาะประตูเว็บเซอร์วิส โดยส่งชื่อผู้ใช้และรหัสผ่านเพื่อเข้าใช้งาน นักพัฒนาทำเช่นนี้เพื่อเข้าถึง API ที่ไม่เปิดเผยสำหรับสาธารณชนทั่วไปหรือเพื่อทำงานแทนผู้ใช้
