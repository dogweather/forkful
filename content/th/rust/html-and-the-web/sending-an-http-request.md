...
## อะไร & ทำไม?
การส่งคำขอ HTTP คือการดึงข้อมูลจากหรือส่งข้อมูลไปยังเว็บเซิร์ฟเวอร์ โปรแกรมเมอร์ทำเช่นนี้เพื่อโต้ตอบกับบริการเว็บหรือ API — ไม่ว่าจะเป็นการรับข้อมูล, โพสต์อัปเดต, คุณก็บอกมาเถอะ
