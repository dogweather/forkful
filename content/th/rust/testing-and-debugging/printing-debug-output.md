...
## อะไรและทำไม?
การพิมพ์ข้อมูลเพื่อแก้ปัญหาช่วยให้คุณสามารถดูสถานะโปรแกรมของคุณได้โดยไม่ต้องใช้เดบักเกอร์แบบเต็มรูปแบบ มันรวดเร็ว ง่าย และเหมาะสำหรับติดตามบั๊กที่ยุ่งยากเมื่อคุณไม่ต้องการอำนาจของเครื่องมือการแก้ไขปัญหาที่เชี่ยวชาญ
