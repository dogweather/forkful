...
## อะไรและทำไม?
การอ่านอาร์กิวเมนต์จากบรรทัดคำสั่งใน Ruby ช่วยให้สคริปต์สามารถรับข้อมูลได้ทันทีเมื่อมันถูกรัน เช่น การกำหนดตัวเลือกหรือส่งข้อมูล โปรแกรมเมอร์ใช้พวกเขาในการทำให้สคริปต์มีความยืดหยุ่นและปรับได้โดยไม่ต้องเขียนค่าเป็นแบบแข็ง
