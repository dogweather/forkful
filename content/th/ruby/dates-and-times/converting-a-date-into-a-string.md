...
## อะไรและทำไม?
การแปลงวันที่เป็นสตริงมีวัตถุประสงค์เพื่อนำวัตถุวันที่มาเปลี่ยนให้เป็นข้อความที่เราสามารถอ่านและใช้งานได้ โปรแกรมเมอร์ทำการนี้เพื่อแสดงวันที่ในรูปแบบที่เข้าใจง่ายสำหรับมนุษย์หรือเตรียมข้อมูลสำหรับการจัดเก็บและแลกเปลี่ยน เช่น ในไฟล์ JSON หรือ CSV 
