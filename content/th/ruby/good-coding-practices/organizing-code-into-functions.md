...
## อะไรและทำไม?
การจัดระเบียบโค้ดเข้าไปในฟังก์ชันช่วยแบ่งสคริปต์ของคุณออกเป็นส่วนที่สามารถนำกลับมาใช้ได้อีก. ทั้งหมดนี้เกี่ยวกับการทำให้โค้ดของคุณสะอาด จัดการได้ง่าย และมีข้อผิดพลาดน้อยลง Modular โค้ดมอบประโยชน์หลายอย่างเนื่องจากระหว่างประหยัดเวลา รักษาสติ และทำให้การดีบักและการทดสอบยูนิตง่ายขึ้น
