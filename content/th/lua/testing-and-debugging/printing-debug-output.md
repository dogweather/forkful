...
## อะไรและทำไม?
การพิมพ์ข้อมูลแก้ไขข้อผิดพลาด (Debug Output) คือการส่งข้อมูลขึ้นจอเพื่อดูว่ามีอะไรเกิดขึ้นกับโค้ดของคุณบ้าง โปรแกรมเมอร์ทำเช่นนี้เพื่อตามหาสาเหตุของปัญหาในเครื่อง—หรือที่เรียกว่า bugs
