...
## อะไรและทำไม?
การทำงานกับ JSON ใน Lua หมายถึงการแปลงสตริงที่เป็นรูปแบบ JSON เป็นตาราง Lua และในทางกลับกัน เพื่อให้สามารถแลกเปลี่ยนข้อมูลระหว่างแอพพลิเคชัน Lua กับเว็บเซอร์วิสหรือ API ภายนอกได้ง่าย โปรแกรมเมอร์ทำเช่นนี้เพื่อใช้ประโยชน์จากรูปแบบของ JSON ที่มีน้ำหนักเบาและง่ายต่อการแปลงสำหรับการเก็บข้อมูล, ตั้งค่าการกำหนดค่า, หรือการสื่อสารผ่าน API ได้อย่างมีประสิทธิภาพ
