...
## อะไรและทำไม?
การดำดิ่งเข้าไปในตัวดีบักเกอร์มีด้วยกันเพื่อเดินตามโค้ดของคุณ จับตาดูเหมือนว่าเกียร์กำลังหมุนและจับบัคที่น่ารำคาญได้ทันทีที่มันเกิดขึ้น โปรแกรมเมอร์ใช้ตัวดีบักเกอร์เพราะเป็นเครื่องมือสืบสวนที่ช่วยเราค้นหาว่าสิ่งต่างๆผิดพลาดที่ไหนโดยไม่ต้องฉีกผมออกมา
