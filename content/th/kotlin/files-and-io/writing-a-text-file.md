...
## อะไร & ทำไม?
การเขียนไฟล์ข้อความใน Kotlin หมายถึงการสร้างไฟล์และใส่ข้อความลงไปในนั้น ซึ่งเป็นงานทั่วไปสำหรับการจัดเก็บข้อมูล, การบันทึก, หรือการตั้งค่าการกำหนดค่า โปรแกรมเมอร์ทำเช่นนี้เพื่อบันทึกและจัดการข้อมูลนอกจากพื้นที่หน่วยความจำชั่วคราว ซึ่งช่วยให้มั่นใจว่าข้อมูลมีความยั่งยืนตลอดเซสชัน
