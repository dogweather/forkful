...
การส่งคำขอ HTTP พร้อมการตรวจสอบสิทธิพื้นฐาน (basic authentication) หมายถึงการส่งชื่อผู้ใช้และรหัสผ่านผ่านเว็บเพื่อเข้าถึงทรัพยากรที่ถูกป้องกัน โปรแกรมเมอร์ใช้วิธีนี้เนื่องจากความง่ายในการโต้ตอบกับ API หรือบริการที่ต้องการข้อมูลการเข้าสู่ระบบ
