...
การเขียนไฟล์ข้อความใน Fish Shell ช่วยให้คุณสามารถจัดเก็บข้อมูลอย่างถาวร ทำให้สามารถเรียกคืนหรือจัดการข้อมูลได้ง่าย ไม่ว่าจะเป็นโดย Fish script เดียวกันหรือโปรแกรมอื่นๆ โปรแกรมเมอร์ทำเช่นนี้เพื่อการบันทึก log, บันทึกการตั้งค่าคอนฟิก, หรือส่งออกข้อมูลสำหรับการประมวลผลต่อไป.
