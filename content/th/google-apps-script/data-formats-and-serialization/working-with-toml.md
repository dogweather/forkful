...
TOML ย่อมาจาก Tom's Obvious, Minimal Language ซึ่งเป็นรูปแบบไฟล์การกำหนดค่าที่อ่านง่ายเนื่องจากมีซีแมนติกที่ชัดเจน โปรแกรมเมอร์มักใช้มันสำหรับไฟล์การกำหนดค่าในแอปพลิเคชันเพราะมันตรงไปตรงมาและเป็นมิตรกับผู้คน ทำให้การจัดการการตั้งค่าและการกำหนดค่าของแอปพลิเคชันเป็นไปอย่างราบรื่นในสภาพแวดล้อมที่แตกต่างกัน
