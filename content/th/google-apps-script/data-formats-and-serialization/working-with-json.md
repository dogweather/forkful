...
JSON หรือ JavaScript Object Notation เป็นรูปแบบที่เบาและเหมาะสำหรับการเก็บและขนส่งข้อมูล ซึ่งเหมาะสำหรับการสื่อสารจากเซิร์ฟเวอร์ไปยังลูกค้าและไฟล์การตั้งค่า โปรแกรมเมอร์ใช้ประโยชน์จากมันใน Google Apps Script เพื่อการแลกเปลี่ยนข้อมูลที่ราบรื่นระหว่างบริการของ Google (เช่น Sheets, Docs, Drive) และแหล่งข้อมูลภายนอก เนื่องจากมีโครงสร้างที่อ่านได้ง่ายและสามารถรวมเข้ากับสภาพแวดล้อมที่ใช้ JavaScript ได้ง่าย
