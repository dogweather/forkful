...
การส่งคำขอ HTTP ใน Google Apps Script เกี่ยวข้องกับการเรียกไปยังเว็บเซิร์ฟเวอร์ภายนอกหรือ API แบบโปรแกรมเมติก โปรแกรมเมอร์ทำเช่นนี้เพื่อดึงหรือส่งข้อมูลไปยังเว็บเซอร์วิส โดยการผสานความสามารถและทรัพยากรเว็บที่หลากหลายเข้ากับโปรเจกต์ Google Apps Script ของพวกเขาโดยตรง
