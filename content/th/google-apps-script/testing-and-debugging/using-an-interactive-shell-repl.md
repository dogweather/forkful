...
Shell แบบโต้ตอบ, หรือ Read-Eval-Print Loop (REPL), เป็นสภาพแวดล้อมการเขียนโปรแกรมแบบง่าย ๆ ที่รับอินพุตผู้ใช้เป็นรายบุคคล (นิพจน์), ประเมินค่า, และส่งคืนผลลัพธ์ให้กับผู้ใช้ REPL ถูกใช้โดยโปรแกรมเมอร์สำหรับการสร้างต้นแบบอย่างรวดเร็ว, การตรวจสอบความผิดพลาด, และการเรียนรู้ไวยากรณ์และพฤติกรรมของภาษาโปรแกรมเชิงโต้ตอบ
