...
## อะไรและทำไม?
การบันทึก (Logging) เป็นเสมือนกับบันทึกการเดินเรือ; คือวิธีการบันทึกเหตุการณ์ที่เกิดขึ้นขณะที่แอปพลิเคชั่นกำลังทำงาน โปรแกรมเมอร์ทำเช่นนี้เพื่อติดตามเหตุการณ์เหล่านี้สำหรับการแก้ไขข้อบกพร่อง, การตรวจสอบการติดตาม, หรือเพื่อรับข้อมูลเชิงลึกเกี่ยวกับพฤติกรรมของระบบในสภาพการผลิต
