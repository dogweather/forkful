...
การส่งคำขอ HTTP ด้วยการตรวจสอบสิทธิ์พื้นฐานเกี่ยวข้องกับการเพิ่มชื่อผู้ใช้และรหัสผ่านลงในคำขอสำหรับทรัพยากรที่จำกัด โปรแกรมเมอร์ทำเช่นนี้เพื่อเข้าถึง API หรือเว็บที่ต้องการความปลอดภัยบางระดับ
