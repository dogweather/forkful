...
## อะไรและทำไม?
การแปลงวันที่เป็นสตริงหมายความว่าการเปลี่ยนวัตถุวันที่เป็นข้อความที่อ่านได้โดยมนุษย์ โปรแกรมเมอร์ทำแบบนี้เพื่อแสดงวันที่ในรูปแบบที่เข้าใจได้หรือเพื่อเอาไว้เขียนลงพื้นที่จัดเก็บหรือส่งข้อมูล
