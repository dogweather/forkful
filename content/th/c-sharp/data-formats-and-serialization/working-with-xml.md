...
## คืออะไร & ทำไม?
XML (eXtensible Markup Language) เกี่ยวข้องกับการจัดโครงสร้างข้อมูลในรูปแบบที่อ่านง่าย โปรแกรมเมอร์ใช้ XML สำหรับการกำหนดค่า, การแลกเปลี่ยนข้อมูลระหว่างแอปพลิเคชัน, และในสถานที่ที่มาตรฐานกำหนดไว้ - นึกถึง SOAP หรือ web APIs.
