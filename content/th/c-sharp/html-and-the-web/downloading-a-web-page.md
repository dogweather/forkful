...
การดาวน์โหลดหน้าเว็บหมายถึงการคว้าเนื้อหา HTML ดิบจากอินเทอร์เน็ตโดยใช้โค้ด โปรแกรมเมอร์ทำเช่นนี้เพื่อประมวลผลข้อมูล โต้ตอบกับเว็บเซอร์วิส หรือเพียงแค่บันทึกข้อมูลสำหรับใช้งานแบบออฟไลน์
