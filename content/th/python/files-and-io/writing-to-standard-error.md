...
## อะไรและทำไม?
การเขียนไปยัง standard error ใน Python คือการเลือกส่งข้อความหรือการวินิจฉัยข้อผิดพลาดของโปรแกรมไปยังสตรีมข้อผิดพลาด (`stderr`), ซึ่งแยกจากการส่งออกมาตรฐาน (`stdout`). โปรแกรมเมอร์ทำเช่นนี้เพื่อแยกความแตกต่างระหว่างผลลัพธ์ปกติของโปรแกรมกับข้อความข้อผิดพลาด, ซึ่งช่วยให้การดีบักและการวิเคราะห์บันทึกง่ายขึ้น
