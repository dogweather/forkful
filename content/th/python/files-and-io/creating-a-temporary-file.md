...
## อะไร & ทำไม?
การสร้างไฟล์ชั่วคราวหมายถึงการทำไฟล์ที่คุณไม่ต้องการให้มีอยู่ตลอดไปเมื่อคุณใช้งานเสร็จสิ้นไปแล้ว โปรแกรมเมอร์ทำสิ่งนี้สำหรับข้อมูลที่ต้องการเฉพาะในระหว่างการทำงานของโปรแกรม เช่น ผลลัพธ์กลางหรือเพื่อหลีกเลี่ยงการใช้หน่วยความจำเกินมาตรฐาน
