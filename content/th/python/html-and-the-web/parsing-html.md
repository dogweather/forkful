...
## อะไรและทำไม?
การแยกวิเคราะห์ HTML หมายถึงการวิเคราะห์โค้ด HTML ของเว็บเพจเพื่อดึงข้อมูลหรือส่วนประกอบที่เฉพาะเจาะจงออกมา ซึ่งเป็นงานทั่วไปสำหรับการเก็บข้อมูลจากเว็บ (web scraping), การขุดข้อมูล (data mining) หรือการทำแบบอัตโนมัติกับการโต้ตอบกับเว็บไซต์ โปรแกรมเมอร์ทำสิ่งนี้เพื่อโต้ตอบกับหรือดึงข้อมูลจากเว็บไซต์โดยวิธีโปรแกรม, ทำงานอย่างอัตโนมัติ, หรือทดสอบเว็บแอปพลิเคชัน
