...
## อะไรและทำไม?
REPL (Read-Eval-Print-Loop) เป็นสภาพแวดล้อมการเขียนโปรแกรมแบบง่าย ๆ แต่โต้ตอบได้ นักพัฒนาใช้มันเพื่อทดลองภาษาแบบเรียลไทม์, งานเล็กๆ น้อยๆ, หรือเพื่อเข้าใจแนวคิดใหม่ๆ โดยไม่ต้องสร้างแอปพลิเคชันที่เต็มรูปแบบ
