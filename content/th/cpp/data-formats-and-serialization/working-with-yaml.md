...
YAML ย่อมาจาก YAML Ain't Markup Language เป็นรูปแบบการซีเรียไลซ์ข้อมูลที่อ่านได้โดยมนุษย์ โปรแกรมเมอร์ใช้สำหรับไฟล์การตั้งค่า, การถ่ายโอนข้อมูล, และการเก็บข้อมูลแบบลำดับชั้นเนื่องจากมีความสามารถในการอ่านง่ายและมีไวยากรณ์ที่เข้าใจง่ายเมื่อเทียบกับ XML หรือ JSON
