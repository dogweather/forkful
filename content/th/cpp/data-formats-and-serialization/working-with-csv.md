...
การทำงานกับไฟล์ CSV (Comma Separated Values) คือการประมวลผลและจัดการข้อมูลที่เก็บอยู่ในรูปแบบข้อความง่ายๆ โดยที่แต่ละบรรทัดของข้อความแทนแถวหนึ่งในตาราง และใช้จุลภาคแยกคอลัมน์แต่ละคอลัมน์ โปรแกรมเมอร์ใช้ประโยชน์จากสิ่งนี้ในการนำเข้า ส่งออก และจัดการข้อมูลต่างๆ ระหว่างระบบต่างๆ เนื่องจาก CSV ได้รับการยอมรับอย่างแพร่หลายว่าเป็นรูปแบบการแลกเปลี่ยนข้อมูลที่เบา อ่านง่ายสำหรับมนุษย์
