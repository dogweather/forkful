...
## อะไร & ทำไม?
นิพจน์ปรกติใน C++ เป็นลำดับของอักขระที่กำหนดรูปแบบการค้นหา ใช้สำหรับการจับคู่หรือการแก้ไขสตริง โปรแกรมเมอร์ใช้พวกมันสำหรับงานเช่น การตรวจสอบความถูกต้องของข้อมูลนำเข้า การค้นหาเหตุการณ์ภายในสตริง หรือการแบ่งสตริงเป็นโทเค็น ทำให้เป็นเครื่องมือที่จำเป็นไม่ได้สำหรับการประมวลผลข้อความที่มีประสิทธิภาพและได้ผล
