...
## อะไร & ทำไม?
JSON หรือ JavaScript Object Notation เป็นรูปแบบการแลกเปลี่ยนข้อมูลที่เบาและง่ายต่อการอ่านและเขียนสำหรับมนุษย์ และง่ายต่อการแยกวิเคราะห์และสร้างขึ้นสำหรับเครื่องจักร โปรแกรมเมอร์มักจะทำงานกับ JSON เพื่อแลกเปลี่ยนข้อมูลระหว่างเซิร์ฟเวอร์และเว็บแอพพลิเคชันเนื่องจากความเรียบง่ายและไม่ขึ้นกับภาษา ทำให้เป็นหนึ่งในส่วนสำคัญของการพัฒนาเว็บสมัยใหม่และ API
