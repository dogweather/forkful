...
YAML ย่อมาจาก "YAML Ain't Markup Language" เป็นรูปแบบการซีเรียไลซ์ข้อมูลที่อ่านได้โดยมนุษย์ ซึ่งมักใช้สำหรับไฟล์การกำหนดค่า โปรแกรมเมอร์เลือกที่จะใช้ YAML เนื่องจากความเรียบง่ายและความสามารถในการอ่านได้ง่าย ทำให้เป็นตัวเลือกที่ยอดเยี่ยมสำหรับการจัดเก็บการตั้งค่า พารามิเตอร์ และแม้กระทั่งโครงสร้างข้อมูลที่ซับซ้อนในรูปแบบที่จัดการได้ง่าย
