...
## อะไร & ทำไม?
ตัวดีบักเกอร์คือเครื่องมือที่ช่วยให้โปรแกรมเมอร์เข้าใจว่าโค้ดของตนกำลังทำงานอะไรอยู่จริงๆ ในขณะที่มันกำลังรัน เหมือนกับแว่นขยายที่ช่วยให้เราซูมเข้าไปที่บั๊ก—ปัญหาที่ทำให้โปรแกรมของเราล่มหรือให้คำตอบที่ผิด—และกำจัดมัน เราใช้ตัวดีบักเกอร์เพราะมันช่วยเราประหยัดเวลาหลายชั่วโมงจากการใช้คำสั่งพิมพ์และเกมการเดา
