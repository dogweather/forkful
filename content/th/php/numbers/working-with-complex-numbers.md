...
## อะไรและทำไม?
จำนวนเชิงซ้อนประกอบด้วยส่วนจริงและส่วนจินตภาพ, โดยปกติจะเขียนเป็น `a + bi` พวกมันมีความสำคัญในคณิตศาสตร์ขั้นสูง, ฟิสิกส์, วิศวกรรม, และบางอัลกอริทึมของคอมพิวเตอร์ โปรแกรมเมอร์ทำงานกับพวกมันเพื่อจัดการการคำนวณที่เกี่ยวข้องกับรากที่สองของตัวเลขติดลบ และฟังก์ชันแกว่ง
