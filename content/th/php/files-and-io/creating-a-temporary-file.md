...
## อะไรและทำไม?
การสร้างไฟล์ชั่วคราวด้วย PHP หมายถึงการทำไฟล์ที่มีอยู่ชั่วขณะเพื่อให้คุณใช้เท่านั้น จากนั้น พึ่ง—มันจะหายไป เหตุผลที่ทำเช่นนี้คืออะไร? มันเหมาะสำหรับการจัดการกับข้อมูลขณะที่กำลังประมวลผล, รักษาข้อมูลลับไม่ให้อยู่บนดิสก์, และรับรองว่าไม่มีร่องรอยใดๆ ที่เหลืออยู่หลังจากสคริปต์ของคุณเสร็จสิ้น
