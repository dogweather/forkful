...
## อะไร & ทำไม?
เริ่มต้นการทำโปรเจคใหม่คือการพับแขนเสื้อขึ้นและตั้งค่าสภาพแวดล้อมเริ่มต้นและไฟล์สำหรับการเขียนโค้ดของคุณ โปรแกรมเมอร์เริ่มต้นโปรเจคใหม่เพื่อแปลงไอเดียเป็นซอฟต์แวร์ที่ใช้การได้ ค่อนข้างเหมือนกับการปลูกเมล็ดสำหรับต้นไม้ดิจิตอล
