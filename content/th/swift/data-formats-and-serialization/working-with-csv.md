...
การทำงานกับไฟล์ CSV (Comma-Separated Values) หมายถึงกระบวนการแยกและสร้างข้อมูลที่มีโครงสร้างจากไฟล์ข้อความที่แต่ละบรรทัดแทนรายการหนึ่ง ๆ และแต่ละรายการประกอบด้วยฟิลด์ที่คั่นด้วยเครื่องหมายจุลภาค นักพัฒนาซอฟต์แวร์มักจะทำกิจกรรมนี้เพื่อนำเข้า ส่งออก และจัดการข้อมูลแบบตารางได้ง่ายๆ โดยใช้รูปแบบที่ได้รับการสนับสนุนอย่างแพร่หลายทั่วแพลตฟอร์มและภาษาการเขียนโปรแกรมต่างๆ เนื่องจากมีความเรียบง่ายและรูปแบบที่อ่านได้โดยมนุษย์
