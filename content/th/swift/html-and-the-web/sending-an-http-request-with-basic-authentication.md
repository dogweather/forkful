...
การส่งคำขอ HTTP พร้อมการตรวจสอบสิทธิพื้นฐาน (Basic Authentication) หมายถึง การแนบชื่อผู้ใช้งานและรหัสผ่านเข้ากับคำขอเพื่อเข้าถึงเนื้อหาเว็บที่ถูกป้องกัน เหตุผลที่นักพัฒนาทำเช่นนี้ เพื่อเข้าถึง API หรือทรัพยากรที่จำกัดเฉพาะผู้ใช้ที่ได้รับอนุญาตเท่านั้น
