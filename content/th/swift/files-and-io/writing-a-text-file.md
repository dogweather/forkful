...
การเขียนไฟล์ข้อความด้วย Swift ช่วยให้คุณเก็บข้อมูลสตริงไว้บนระบบไฟล์อย่างถาวร ซึ่งเป็นสิ่งจำเป็นสำหรับงานเช่น การบันทึกการตั้งค่าคอนฟิก, ข้อมูลผู้ใช้ หรือ บันทึกการใช้งาน โปรแกรมเมอร์มักทำสิ่งนี้เพื่อรักษาข้อมูลระหว่างการเปิดแอปซ้ำๆ, แบ่งปันข้อมูลระหว่างส่วนต่างๆ ของแอปพลิเคชัน, หรือส่งออกข้อมูลเพื่อใช้กับโปรแกรมอื่น
