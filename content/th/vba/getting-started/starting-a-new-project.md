...
การเริ่มต้นโปรเจ็กต์ใหม่ใน Visual Basic for Applications (VBA) คือการตั้งค่าสภาพแวดล้อมภายในแอพพลิเคชันโฮสต์ เช่น Excel, เพื่ออัตโนมัติการทำงานหรือขยายฟังก์ชันการทำงาน โปรแกรมเมอร์หันมาใช้พื้นที่นี้เพื่อใช้ประโยชน์จาก VBA ในการปรับแต่งและอัตโนมัติแอพพลิเคชัน Microsoft Office, ด้วยวิธีนี้จึงช่วยให้กระบวนการทำงานเป็นไปอย่างราบรื่นและเพิ่มผลผลิต
