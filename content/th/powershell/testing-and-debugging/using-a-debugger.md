...
## อะไรและทำไม?
การใช้งานตัวแก้จุดบกพร่องหมายถึงการตั้งจุดหยุด (breakpoints), การเดินผ่านโค้ดของคุณ, การดูตัวแปร, และการตรวจสอบสถานะของโปรแกรมขณะที่มันกำลังทำงาน มันเป็นเครื่องเปลี่ยนเกมสำหรับนักพัฒนาเพราะมันช่วยระบุจุดบกพร่องและช่วยให้เราเข้าใจว่าโค้ดของเราทำงานอย่างไรจริงๆ
