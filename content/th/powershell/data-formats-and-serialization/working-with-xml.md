...
## อะไร & ทำไม?
การทำงานกับ XML หมายถึงการจัดการและเข้าถึงข้อมูลที่มีโครงสร้างในภาษา eXtensible Markup Language นักพัฒนาทำงานกับ XML เพื่อให้เข้ากันได้กับระบบอื่น หรือเพื่ออ่านและเขียนไฟล์การกำหนดค่า, ฟีดข้อมูล, และเอกสารที่มีโครงสร้างอื่นๆ ที่พบบ่อยในเว็บเซอร์วิส
