...
## คืออะไร & ทำไม?
การจัดระเบียบโค้ดเข้ากับฟังก์ชันคือการห่อหุ้มกลุ่มของโค้ดที่ทำงานเฉพาะกิจแล้วให้ชื่อกับมัน การทำเช่นนี้ทำให้โค้ดสามารถนำมาใช้ซ้ำได้ อ่านง่าย และบำรุงรักษาได้ แทนที่จะเขียนโค้ดเดิมซ้ำๆ ให้เรียกใช้ฟังก์ชัน เมื่อต้องการแก้ปัญหาหรืออัพเกรด? ปรับเปลี่ยนฟังก์ชันโดยไม่ต้องค้นหาในกองของสคริปต์
