...
การจัดการไฟล์ด้วย CLI one-liners ใน PowerShell คือการเปลี่ยนแปลง, ย้าย หรือ เรียกข้อมูลไฟล์ได้อย่างรวดเร็วโดยตรงจาก command line นักโปรแกรมมิ่งทำสิ่งนี้เพื่อประสิทธิภาพ; มันเร็วกว่าการเดินทางผ่าน GUI หรือการเขียนสคริปต์ที่ยาวสำหรับงานง่ายๆ
