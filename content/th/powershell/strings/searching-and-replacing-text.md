...
date: 2024-03-17 21:50:54.861793-06:00
description: "\u0E01\u0E32\u0E23\u0E04\u0E49\u0E19\u0E2B\u0E32\u0E41\u0E25\u0E30\u0E41\
  ...
  \u0E2D\u0E31\u0E1B\u0E40\u0E14\u0E15\u0E42\u0E04\u0E49\u0E14, \u0E41\u0E01\u0E49\
  \u0E44\u0E02\u0E02\u0E49\u0E2D\u0E1C\u0E34\u0E14\u0E1E\u0E25\u0E32\u0E14\u2026"
lastmod: '2024-03-17T21:57:56.424398-06:00'
...
## อะไรและทำไม?
การค้นหาและแทนที่ข้อความในไฟล์: นั่นคือการสลับคำหรือวลีด้วยคำหรือวลีอื่น ๆ โปรแกรมเมอร์ใช้มันเพื่ออัปเดตโค้ด, แก้ไขข้อผิดพลาด หรือเปลี่ยนแปลงข้อมูลในหลายไฟล์อย่างรวดเร็วโดยไม่ต้องค้นหาด้วยตนเองทีละไฟล์
...
## ดูเพิ่มเติม
- การเอกสารของตัวดำเนินการ `-replace` ของ PowerShell: [ลิงค์](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_comparison_operators)
- การใช้ `Get-Content` และ `Set-Content`: [ลิงค์](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.management/get-content)
