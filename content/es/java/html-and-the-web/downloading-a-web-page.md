...
description: "C\xF3mo hacerlo: Para descargar una p\xE1gina web en Java, podemos usar\
  \ la clase `HttpClient` que facilita realizar peticiones HTTP. Aqu\xED hay un ejemplo\
  \ simple."
lastmod: '2024-03-13T22:44:58.936435-06:00'
model: gpt-4-1106-preview
summary: "Para descargar una p\xE1gina web en Java, podemos usar la clase `HttpClient`\
  \ que facilita realizar peticiones HTTP."
