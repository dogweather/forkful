...
description: "C\xF3mo hacerlo: Ruby hace esto f\xE1cil con bibliotecas como `open-uri`\
  \ y `nokogiri`. Aqu\xED hay un ejemplo b\xE1sico con `open-uri`."
lastmod: '2024-03-13T22:44:59.590367-06:00'
model: gpt-4-1106-preview
summary: "Ruby hace esto f\xE1cil con bibliotecas como `open-uri` y `nokogiri`."
