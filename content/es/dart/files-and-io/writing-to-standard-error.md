...
description: "C\xF3mo hacerlo: En Dart, escribir en stderr es sencillo usando el objeto\
  \ `stderr` disponible en `dart:io`. Aqu\xED hay un ejemplo b\xE1sico."
lastmod: '2024-03-13T22:44:58.772053-06:00'
model: gpt-4-0125-preview
summary: En Dart, escribir en stderr es sencillo usando el objeto `stderr` disponible
  en `dart:io`.
