...
description: "C\xF3mo hacerlo: En TypeScript, vamos directo al grano con `fs` y `tmp`\
  \ para crear un archivo temporal."
lastmod: '2024-03-13T22:44:58.822605-06:00'
model: gpt-4-1106-preview
summary: En TypeScript, vamos directo al grano con `fs` y `tmp` para crear un archivo
  temporal.
