...
description: "C\xF3mo hacerlo: Desglosemos el uso de `pdb`, el depurador integrado\
  \ de Python. Imagina un archivo, `buggy.py`, con un error dif\xEDcil de encontrar."
