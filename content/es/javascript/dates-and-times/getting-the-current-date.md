...
description: "C\xF3mo hacerlo: En JavaScript puro (vanilla), el objeto `Date` se utiliza\
  \ para trabajar con fechas y horas. As\xED es como puedes obtener la fecha y hora\u2026"
lastmod: '2024-03-13T22:44:59.468982-06:00'
model: gpt-4-0125-preview
summary: En JavaScript puro (vanilla), el objeto `Date` se utiliza para trabajar con
  fechas y horas.
