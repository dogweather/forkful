...
TOML, যা Tom's Obvious, Minimal Language এর সংক্ষেপ, একটি ডাটা সিরিয়ালাইজেশন ভাষা। Elm প্রোগ্রামাররা এটিকে কনফিগারেশন ডাটা পরিচালনা করতে ব্যবহার করে কারণ এটি মানুষের পড়ার জন্য সহজ এবং অ্যাপ্লিকেশনের প্রয়োজনীয় কী-মান জুটিগুলিতে সুচারুভাবে মানচিত্রিত করে।
