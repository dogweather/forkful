...
date:                  2024-03-17T18:13:11.618741-06:00
...
Go তে একটি স্ট্রিং থেকে কোটেশন চিহ্ন (`"` অথবা `'`) মুছে ফেলা মানে দেওয়া একটি স্ট্রিং থেকে শুরুর ও শেষের কোটেশন চিহ্ন দূর করা। প্রোগ্রামারদের প্রায়ই এই কাজটি করতে হয়, যেমন ব্যবহারকারীর ইনপুট সাফ করতে, টেক্সট ডাটা আরও কার্যকরভাবে পার্স করতে, অথবা আরও প্রক্রিয়া করার জন্য স্ট্রিং কে কোটেশন মুক্ত করতে।
