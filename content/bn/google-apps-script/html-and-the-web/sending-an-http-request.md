...
Google Apps Script এ HTTP অনুরোধ পাঠানো মানে একটি বাহ্যিক ওয়েব সার্ভার অথবা API এর সাথে প্রোগ্রামাত্মকভাবে একটি কল করা। প্রোগ্রামাররা ওয়েব সেবাগুলি থেকে ডেটা পুনরুদ্ধার অথবা ডেটা পাঠানোর জন্য এটি করে। উন্নত ওয়েব সম্পদ এবং কার্যকারিতা সরাসরি তাদের Google Apps Script প্রকল্পে সমন্বিত করে।
