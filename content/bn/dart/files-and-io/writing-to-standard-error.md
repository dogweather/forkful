...
Dart এ স্ট্যান্ডার্ড এরর (stderr) এ লেখা মানে হল এরর ম্যাসেজ এবং ডায়াগনস্টিকস একটি পৃথক স্ট্রিমে পাঠানো, যা স্ট্যান্ডার্ড আউটপুট (stdout) থেকে আলাদা। প্রোগ্রামাররা এটি করেন নরমাল প্রোগ্রাম আউটপুট এবং এরর বা ওয়ার্নিং ম্যাসেজগুলির মধ্যে পার্থক্য করতে, যা ডিবাগিং এবং লগিংকে আরও সহজ করে তোলে।
