...
description: 'How to: C++ has a built-in library `<complex>` that eases working with
  complex numbers. Here''s a quick look.'
lastmod: '2024-03-13T22:45:00.352236-06:00'
model: gpt-4-1106-preview
summary: C++ has a built-in library `<complex>` that eases working with complex numbers.
