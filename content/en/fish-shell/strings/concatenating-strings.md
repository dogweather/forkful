...
description: 'How to: In Fish, slap strings together with spaces between or use `string
  join`.'
lastmod: '2024-03-13T22:45:00.464973-06:00'
model: gpt-4-1106-preview
summary: In Fish, slap strings together with spaces between or use `string join`.
