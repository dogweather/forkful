...
description: 'How to: In C#, you have the `DateTime` object and a bunch of ways to
  turn it into a string. Here are a few.'
lastmod: '2024-03-13T22:45:00.099694-06:00'
model: gpt-4-1106-preview
summary: In C#, you have the `DateTime` object and a bunch of ways to turn it into
  a string.
