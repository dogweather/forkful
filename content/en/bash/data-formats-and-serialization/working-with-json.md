...
description: "How to: Bash itself lacks built-in JSON parsing capabilities, but `jq`\
  \ is a powerful command-line JSON processor that fills this gap. Here's how to use\u2026"
lastmod: '2024-03-13T22:45:00.263329-06:00'
model: gpt-4-0125-preview
summary: Bash itself lacks built-in JSON parsing capabilities, but `jq` is a powerful
  command-line JSON processor that fills this gap.
