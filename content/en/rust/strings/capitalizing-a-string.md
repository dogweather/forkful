...
summary: Capitalizing a string in Rust involves modifying the string so that its first
  character is uppercase if it's a letter, while leaving the rest of the string unchanged.
