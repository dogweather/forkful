...
aliases: - /zh/vba/sending-an-http-request-with-basic-authentication.md
date:                  2024-02-01T22:04:00.725036-07:00
model:                 gpt-4-0125-preview
simple_title:         "使用基本认证发送HTTP请求"
tag:                  "HTML and the Web"
editURL:              "https://github.com/dogweather/forkful/blob/master/content/zh/vba/sending-an-http-request-with-basic-authentication.md"
changelog:
...
在 Visual Basic for Applications (VBA) 中使用基本认证发送 HTTP 请求涉及到访问受用户名和密码凭据保护的 web 资源。程序员这样做是为了与其 VBA 驱动的应用程序中的安全 API 或网络服务进行交互，例如在 Excel 或 Access 中自动化执行任务，这些任务来自于受保护端点的数据。
