...
- [हास्केल डॉक्यूमेंटेशन पर Text.HTML.DOM](https://hackage.haskell.org/package/xhtml-3000.2.2.1/docs/Text-HTML-DOM.html)
- [HTML पार्सिंग के बारे में विकिपीडिया लेख](https://en.wikipedia.org/wiki/HTML_parsing)