...
aliases:
- hi/vba/sending-an-http-request-with-basic-authentication.md
date:                  2024-02-01T22:04:04.914628-07:00
model:                 gpt-4-0125-preview
simple_title:         "बेसिक ऑथेंटिकेशन के साथ HTTP अनुरोध भेजना"
tag:                  "HTML and the Web"
editURL:              "https://github.com/dogweather/forkful/blob/master/content/hi/vba/sending-an-http-request-with-basic-authentication.md"
changelog:
...
विजुअल बेसिक फॉर एप्लीकेशन्स (VBA) में बेसिक प्रमाणीकरण के साथ एचटीपी अनुरोध भेजना उन वेब संसाधनों तक पहुँचने के बारे में है जिनकी सुरक्षा यूजरनेम और पासवर्ड क्रेडेंशियल्स से की जाती है। प्रोग्रामर ऐसा सुरक्षित एपीआई या वेब सेवाओं के साथ इंटरैक्ट करने के लिए करते हैं, जैसे कि Excel या Access में डेटा के साथ कार्यों को स्वचालित करना सुरक्षित अंतिम बिंदुओं से।
