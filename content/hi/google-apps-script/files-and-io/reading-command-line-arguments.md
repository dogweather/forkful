...
aliases: - /hi/google-apps-script/reading-command-line-arguments.md
date:                  2024-02-01T22:05:04.321516-07:00
model:                 gpt-4-0125-preview
simple_title:         "कमांड लाइन तर्कों को पढ़ना"
tag:                  "Files and I/O"
editURL:              "https://github.com/dogweather/forkful/blob/master/content/hi/google-apps-script/reading-command-line-arguments.md"
changelog:
...
Google Apps Script में कमांड लाइन आर्ग्यूमेंट्स को पढ़ना थोड़ा मिथ्याभास है क्योंकि, पाइथन या नोड.जेएस जैसी प्रोग्रामिंग भाषाओं में पारंपरिक कमांड-लाइन इंटरफेस के विपरीत, Google Apps Script स्वाभाविक रूप से कमांड लाइन निष्पादन या आर्ग्यूमेंट पासिंग का समर्थन नहीं करता है। इसके बजाय, कोडर्स अक्सर वेब ऐप्स या स्वचालित कार्यों को चलाते समय कस्टम फ़ंक्शन और URL पैरामीटर्स के माध्यम से इस प्रक्रिया का अनुकरण करते हैं, उपयोगकर्ता इनपुट्स या पूर्व निर्धारित पैरामीटर्स के आधार पर स्क्रिप्ट कार्यक्षमताओं के साथ गतिशील इंटरैक्शन को सक्रिय करते हैं।
