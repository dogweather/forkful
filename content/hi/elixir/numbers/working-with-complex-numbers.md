...
aliases: - /hi/elixir/working-with-complex-numbers.md
date:                  2024-01-26T04:40:53.115461-07:00
model:                 gpt-4-0125-preview
simple_title:         "जटिल संख्याओं के साथ काम करना"

tag:                  "Numbers"
editURL:              "https://github.com/dogweather/forkful/blob/master/content/hi/elixir/working-with-complex-numbers.md"
---

{{< edit_this_page >}}

## क्या और क्यों?
जटिल संख्याओं में एक वास्तविक भाग और एक काल्पनिक भाग होता है (जैसे `3 + 4i`)। वे इंजीनियरिंग, भौतिकी, और कुछ कंप्यूटिंग समस्याओं में उपयोग किए जाते हैं। प्रोग्रामर उनके साथ सिमुलेशन, सिग्नल प्रोसेसिंग, और कुछ प्रकार के गणित समस्याओं को कुशलता से हल करने के लिए काम करते हैं।
