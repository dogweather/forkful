...
aliases: - /hi/fish-shell/using-an-interactive-shell-repl.md
date:                  2024-01-26T04:15:17.339441-07:00
model:                 gpt-4-0125-preview
simple_title:         "इंटरैक्टिव शेल (REPL) का उपयोग"

tag:                  "Testing and Debugging"
editURL:              "https://github.com/dogweather/forkful/blob/master/content/hi/fish-shell/using-an-interactive-shell-repl.md"
---

{{< edit_this_page >}}

## क्या और क्यों?
REPL, या Read-Eval-Print Loop, एक इंटरैक्टिव प्रोग्रामिंग वातावरण है जो एकल उपयोगकर्ता इनपुट्स को लेता है, उन्हें निष्पादित करता है, और परिणाम लौटाता है। प्रोग्रामर इसे तत्काल प्रतिक्रिया, डिबगिंग, और कोडिंग अवधारणाओं के साथ तेजी से प्रयोग करने के लिए उपयोग करते हैं बिना किसी पूर्ण प्रोग्राम को कंपाइल और चलाने की अधिक प्रक्रिया के।
