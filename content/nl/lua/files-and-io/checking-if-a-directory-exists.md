...
description: "Hoe te: Lua heeft geen ingebouwde mapafhandeling in zijn standaardbibliotheken.\
  \ Je gebruikt vaak `os.execute` met `test` op Unix of `os.getenv` op\u2026"
lastmod: '2024-03-13T22:44:50.951688-06:00'
model: gpt-4-0125-preview
summary: Lua heeft geen ingebouwde mapafhandeling in zijn standaardbibliotheken.
