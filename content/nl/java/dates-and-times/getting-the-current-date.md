...
aliases: - /nl/java/getting-the-current-date.md
...
De huidige datum in Java verkrijgen is een fluitje van een cent – het draait allemaal om het gebruiken van de juiste klasse om de huidige dag uit de systeemklok te halen. Programmeurs doen dit voor het bijhouden, loggen, of om hun apps te voorzien van tijdgevoelige functies.
