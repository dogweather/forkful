...
description: "Hoe: Bash wordt niet geleverd met een ingebouwde debugger zoals sommige\
  \ andere talen, maar je kunt ingebouwde commando's gebruiken zoals `set -x` om te\u2026"
