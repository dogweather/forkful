...
description: 'Hoe: Om met JSON in Elixir om te gaan, gebruiken we bibliotheken zoals
  `Jason` of `Poison`. Hier is een snelle handleiding met `Jason`.'
lastmod: '2024-03-13T22:44:50.483270-06:00'
model: gpt-4-0125-preview
summary: Om met JSON in Elixir om te gaan, gebruiken we bibliotheken zoals `Jason`
  of `Poison`.
