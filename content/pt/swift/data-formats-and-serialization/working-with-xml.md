...
description: "Como fazer: Swift oferece `XMLParser` e `XMLDocument` para a an\xE1\
  lise de dados XML. Aqui est\xE1 um trecho para analisar uma simples string XML."
lastmod: '2024-03-13T22:44:46.945226-06:00'
model: gpt-4-0125-preview
summary: "Swift oferece `XMLParser` e `XMLDocument` para a an\xE1lise de dados XML."
