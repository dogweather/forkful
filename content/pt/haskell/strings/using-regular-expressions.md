...
description: "Como: Em Haskell, as funcionalidades de regex n\xE3o fazem parte da\
  \ biblioteca padr\xE3o, necessitando do uso de pacotes de terceiros como `regex-base`\
  \ junto\u2026"
lastmod: '2024-03-13T22:44:46.615597-06:00'
model: gpt-4-0125-preview
summary: "Em Haskell, as funcionalidades de regex n\xE3o fazem parte da biblioteca\
  \ padr\xE3o, necessitando do uso de pacotes de terceiros como `regex-base` junto\
  \ com um backend compat\xEDvel como `regex-posix` (para suporte a regex POSIX),\
  \ `regex-pcre` (para regex compat\xEDvel com Perl), etc."
