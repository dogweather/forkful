...
description: "Como Fazer: Em detalhe: - `substring(start, end)` pega desde a posi\xE7\
  ...
  ndices\u2026"
lastmod: '2024-04-05T22:38:46.131873-06:00'
model: gpt-4-1106-preview
summary: "Em detalhe: - `substring(start, end)` pega desde a posi\xE7\xE3o `start`\
  \ at\xE9 `end - 1`. - `slice(start, end)` \xE9 similar, mas aceita \xEDndices negativos\
  \ para contar do fim da string."
