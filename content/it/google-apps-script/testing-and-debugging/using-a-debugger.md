...
description: "Come fare: Google Apps Script fornisce un debugger integrato all'interno\
  \ dell'Editor di Apps Script per aiutare a risolvere i problemi degli script. Ecco\u2026"
...
summary: Google Apps Script fornisce un debugger integrato all'interno dell'Editor
  di Apps Script per aiutare a risolvere i problemi degli script.
