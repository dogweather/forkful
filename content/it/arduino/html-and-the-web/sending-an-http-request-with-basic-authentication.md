...
description: "Inviare una richiesta HTTP con autenticazione di base significa inviare\
...
summary: Inviare una richiesta HTTP con autenticazione di base significa inviare al
  server dati che necessitano di un username e password per accedere a contenuti protetti.
