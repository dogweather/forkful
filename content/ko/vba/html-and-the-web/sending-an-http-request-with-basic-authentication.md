...
aliases: - /ko/vba/sending-an-http-request-with-basic-authentication.md
date:                  2024-02-01T22:02:49.553745-07:00
model:                 gpt-4-0125-preview
simple_title:         "기본 인증을 사용하여 HTTP 요청 보내기"
tag:                  "HTML and the Web"
editURL:              "https://github.com/dogweather/forkful/blob/master/content/ko/vba/sending-an-http-request-with-basic-authentication.md"
changelog:
...
Visual Basic for Applications(VBA)에서 기본 인증을 사용하여 HTTP 요청을 보내는 것은 사용자 이름과 비밀번호 자격 증명으로 보호되는 웹 리소스에 액세스하는 것입니다. 프로그래머는 이를 통해 보안된 API나 웹 서비스와 상호 작용하여 Excel이나 Access 같은 VBA로 구동되는 애플리케이션에서 보안된 엔드포인트로부터 데이터로 작업을 자동화합니다.
