...
description: "TOML\u306F\u3001Tom's Obvious, Minimal Language\u306E\u7565\u3067\u3001\
  ...
  \u3092\u6D3B\u7528\u3057\u3066\u304A\u308A\u3001\u3053\u308C\u306B\u3088\u308AVisual\
  \ Basic for\u2026"
lastmod: '2024-03-11T00:14:15.500848-06:00'
...
TOMLは、Tom's Obvious, Minimal Languageの略で、主に設定ファイルで使用されるデータ直列化形式です。プログラマーは、その読みやすさとデータ構造への簡単なマッピングを活用しており、これによりVisual Basic for Applications（VBA）を含む様々なプログラミング環境でアプリケーションの設定が直接行えます。
