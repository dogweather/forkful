...
description: "How to: Pour t\xE9l\xE9charger une page web en JavaScript, on utilise\
  \ souvent la librairie `axios` ou la fonction `fetch`. Voici un exemple avec `fetch`."
lastmod: '2024-03-13T22:44:58.274332-06:00'
model: gpt-4-1106-preview
summary: "Pour t\xE9l\xE9charger une page web en JavaScript, on utilise souvent la\
  \ librairie `axios` ou la fonction `fetch`."
