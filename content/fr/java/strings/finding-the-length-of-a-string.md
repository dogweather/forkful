...
description: "Comment faire : Historiquement, la m\xE9thode `.length()` fait partie\
  \ de Java depuis ses d\xE9buts. C'est la mani\xE8re la plus directe pour obtenir\
  \ la taille\u2026"
lastmod: '2024-04-05T22:51:11.654082-06:00'
model: gpt-4-1106-preview
summary: "Historiquement, la m\xE9thode `.length()` fait partie de Java depuis ses\
  \ d\xE9buts."
