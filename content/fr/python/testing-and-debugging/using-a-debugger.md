...
description: "Comment faire : D\xE9cortiquons l\u2019utilisation de `pdb`, le d\xE9\
  bogueur int\xE9gr\xE9 de Python. Imaginez un fichier, `buggy.py`, avec un bug sournois\
  \ ."
